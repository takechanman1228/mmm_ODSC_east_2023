...
library("reticulate") 
# point Python path to the python file in the virtual environment. Below is an example
Sys.setenv(RETICULATE_PYTHON = "/Users/take/opt/anaconda3/envs/r-reticulate/bin/python")
...
print(OutputCollect)
select_model <- "1_269_3" # Pick one of the models from OutputCollect to proceed
